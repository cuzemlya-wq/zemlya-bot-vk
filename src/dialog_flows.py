...
Или напишите удобное время для звонка.""",
    ...
    "zouit_guide": DialogStep(
                ...
                Это территории с ограничениями для строительства и использования:

                🔹 Санитарные зоны (возле очистных сооружений)
                🔹 Охранные зоны (линии электропередач, газопроводы)
                🔹 Водоохранные зоны
                🔹 Зоны охраны культурного наследия

                Если ваш участок попадает в ЗОУИТ — это может ограничить:
                • Строительство жилых домов
                • Высоту построек
                • Виды разрешенной деятельности

                Проверьте свой участок, чтобы узнать об ограничениях!""",
                        buttons=[
                                        {"label": "🔍 Проверить участок", "payload": "check_plot"},
                                                    {"label": "⬅️ Главное меню", "payload": "greeting"}
                                                            ]
                                                                ),
